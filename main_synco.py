...
parser.add_argument("--save-dir", default="./results", type=str, help="directory to save checkpoints (default: './results')")
...
# options for synco
parser.add_argument("--n-hard", default=1024, type=int, help="number of hard negatives to consider (default: 1024)")
parser.add_argument("--n1", default=256, type=int, help="number of hard negatives to generate by interpolation (default: 256)")
parser.add_argument("--n2", default=256, type=int, help="number of hard negatives to generate by extrapolation (default: 256)")
parser.add_argument("--n3", default=256, type=int, help="number of hard negatives to generate by mixup method (default: 256)")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        transform = [
            ...
            transforms.RandomGrayscale(p=0.2),
            transforms.RandomApply([synco.loader.GaussianBlur([0.1, 2.0])], p=0.5),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor(),
            normalize,
        ]
